...
var LANG = {
  ko: {
    ...
    loading: '불러오는 중...',
    retry: '다시 시도',
    forecastToggleShow: '12시간 예측 보기',
    forecastToggleHide: '12시간 예측 접기',
  ...
  en: {
    ...
    loading: 'Loading...',
    retry: 'Retry',
    forecastToggleShow: 'Show 12-hour forecast',
    forecastToggleHide: 'Hide 12-hour forecast',
  ...
  ja: {
    ...
    loading: '読み込み中...',
    retry: '再試行',
    forecastToggleShow: '12時間予測を見る',
    forecastToggleHide: '12時間予測を閉じる',
  ...
  zh: {
    ...
    loading: '正在加载...',
    retry: '重试',
    forecastToggleShow: '查看12小时预测',
    forecastToggleHide: '收起12小时预测',
